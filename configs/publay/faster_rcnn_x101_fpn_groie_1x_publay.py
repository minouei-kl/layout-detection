...
log_level = 'INFO'
load_from = '/netscratch/minouei/report/work_dirs/faster_rcnn_x101_freeze_fpn_groie_1x_publay/epoch_1.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/netscratch/minouei/report/work_dirs/faster_rcnn_x101_fpn_groie_1x_publay'
gpu_ids = range(0, 1)
