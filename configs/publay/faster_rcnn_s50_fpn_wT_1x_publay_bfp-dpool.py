...
log_level = 'INFO'
load_from = '/netscratch/minouei/report/work_dirs/faster_rcnn_s50_fpn_wT_1x_publay_bfp_val/epoch_2.pth'
resume_from = None
workflow = [('train', 1)]
norm_cfg = dict(type='SyncBN', requires_grad=True)
work_dir = '/netscratch/minouei/report/work_dirs/faster_rcnn_s50_fpn_wT_1x_publay_bfp_dpool'
gpu_ids = range(0, 1)
