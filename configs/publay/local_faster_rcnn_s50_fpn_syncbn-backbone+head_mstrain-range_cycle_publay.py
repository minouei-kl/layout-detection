...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/minouei/Downloads/datasets/publaynet/train.json',
        img_prefix='/home/minouei/Downloads/datasets/publaynet/train/',
...
workflow = [('train', 1)]
norm_cfg = dict(type='SyncBN', requires_grad=True)
work_dir = './work_dirs/faster_rcnn_s50_fpn_syncbn-backbone+head_mstrain-range_cycle_publay'
gpu_ids = range(0, 1)
