...
log_level = 'INFO'
load_from = '/netscratch/minouei/report/work_dirs/ga_faster_x101_64x4d_freeze_fpn_publay/epoch_1.pth'
resume_from = None
workflow = [('train', 1)]
classes = ('text', 'title', 'list', 'table', 'figure')
num_classes = 5
work_dir = '/netscratch/minouei/report/work_dirs/ga_faster_x101_64x4d_fpn_publay'
gpu_ids = range(0, 1)
