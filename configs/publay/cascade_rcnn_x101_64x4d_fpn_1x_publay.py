...
log_level = 'INFO'
load_from = '/netscratch/minouei/report/work_dirs/cascade_rcnn_x101_64x4d_freeze_fpn_1x_publay/epoch_1.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/netscratch/minouei/report/work_dirs/cascade_rcnn_x101_64x4d_fpn_1x_publay'
gpu_ids = range(0, 1)
